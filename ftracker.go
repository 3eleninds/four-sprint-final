...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	...
	speedWalk := math.Pow(meanSpeed(action, duration), 2)
	return (walkingCaloriesWeightMultiplier * weight * +speedWalk / height * walkingSpeedHeightMultiplier * weight) * duration * minInH
